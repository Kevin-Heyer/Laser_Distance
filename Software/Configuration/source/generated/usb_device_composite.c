...
extern usb_status_t USB_DeviceInterface0HidGenericInit(usb_device_composite_struct_t *deviceComposite);
extern usb_status_t USB_DeviceInterface0HidGenericCallback(class_handle_t handle, uint32_t event, void *param);
extern usb_status_t USB_DeviceInterface0HidGenericSetConfiguration(class_handle_t handle, uint8_t configuration_index);
extern usb_status_t USB_DeviceInterface0HidGenericSetInterface(class_handle_t handle, uint8_t alternateSetting);
...
extern usb_device_class_struct_t g_UsbDeviceInterface0HidGenericConfig;

/* Set class configurations. */
usb_device_class_config_struct_t g_CompositeClassConfig[USB_COMPOSITE_INTERFACE_COUNT] = {
    {
        USB_DeviceInterface0HidGenericCallback, (class_handle_t)NULL, &g_UsbDeviceInterface0HidGenericConfig,
    },
};
    ...
    (defined(USB_DEVICE_CONFIG_KHCI) && (USB_DEVICE_CONFIG_KHCI > 0U))
        ...
        case kUSB_DeviceEventSetConfiguration:
            if (0 == (*temp8))
            {
                ...
                USB_DeviceInterface0HidGenericSetConfiguration(g_UsbDeviceComposite.interface0HidGenericHandle, *temp8);
                error = kStatus_USB_Success;
            }
...
usb_status_t USB_UpdateInterfaceSetting(uint8_t interface, uint8_t alternateSetting)
{
    ...
    case USB_INTERFACE_0_HID_GENERIC_INDEX:
        ret = USB_DeviceInterface0HidGenericSetInterface(g_UsbDeviceComposite.interface0HidGenericHandle, alternateSetting);
        break;
    }
...
usb_status_t USB_DeviceApplicationInit(void)
{
    ...
    g_UsbDeviceComposite.attach = 0U;
    g_UsbDeviceComposite.interface0HidGenericHandle = (class_handle_t)NULL;
    ...
    g_UsbDeviceComposite.interface0HidGenericHandle = g_UsbDeviceCompositeConfigList.config[0].classHandle;
    USB_DeviceInterface0HidGenericInit(&g_UsbDeviceComposite);
